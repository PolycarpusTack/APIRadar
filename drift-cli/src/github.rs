...
const COMMENT_MARKER: &str = "<!-- drift-monitor-report -->";
...
pub fn build_comment(
    ...
    format!(
        "{marker}\n\
## \u{1f50d} Drift Monitor \u{2014} API Contract Check\n\n\
...
> {policy_verdict}\n\n\
<sub>Generated by [Drift Monitor](https://github.com) v0.1.0</sub>\n",
        marker = COMMENT_MARKER,
    )
}
...
fn kind_label(kind: &drift_core::models::ChangeKind) -> &'static str {
    use drift_core::models::ChangeKind;
    match kind {
...
pub async fn post_or_update_comment(ctx: &GithubContext, body: &str) -> Result<String> {
    ...
    default_headers.insert(
        USER_AGENT,
        HeaderValue::from_static("drift-monitor/0.1"),
    );
